window.sampleData = {
  ...
  partners: [
    { id: 1, name: "Kolkata Municipal Corp.", icon: "fas fa-landmark", color: "#0ea5e9", website: "#" },
    { id: 2, name: "State Bank of India", icon: "fas fa-university", color: "#2563eb", website: "#" },
    { id: 3, name: "Apollo Hospitals", icon: "fas fa-hospital", color: "#dc2626", website: "#" },
    { id: 4, name: "Jadavpur University", icon: "fas fa-graduation-cap", color: "#7c3aed", website: "#" },
    { id: 5, name: "Tata Trust", icon: "fas fa-hands-helping", color: "#0891b2", website: "#" },
    { id: 6, name: "Bengal Chamber", icon: "fas fa-briefcase", color: "#d97706", website: "#" },
    { id: 7, name: "Indian Oil Corp.", icon: "fas fa-gas-pump", color: "#059669", website: "#" },
    { id: 8, name: "Rotary Club Kolkata", icon: "fas fa-globe", color: "#e11d48", website: "#" }
  ],
  teamMembers: [
